...
public partial class CustomPieSliceChartPage : ContentPage
{
	public CustomPieSliceChartPage()
	{
		InitializeComponent();
    ...
    public class LabelTextProvider : DevExpress.Maui.Charts.ISeriesLabelTextProvider
    {
        string DevExpress.Maui.Charts.ISeriesLabelTextProvider.GetText(SeriesLabelValuesBase values)
        {
